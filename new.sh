...
echo "  5. When ready to publish, edit $TARGET_DIR/metadata.yml and set draft: false"
echo ""
echo "📝 Note: New presentations are created as drafts by default (draft: true in metadata.yml)"
